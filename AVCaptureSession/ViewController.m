...
-(void)ceateUI
{
    ...
    //[_shutterBtn setImage:[UIImage imageNamed:@"camera_h"] forState:UIControlStateHighlighted];
        [_shutterBtn setTitle:@"C" forState:UIControlStateNormal];
...
-(void)createFunctionalUI
{
    ...
    _focalBtn.layer.borderColor=[UIColor redColor].CGColor;
    ...
    //闪光灯开启后关闭按钮
    UIButton *flashBtn=[[UIButton alloc]initWithFrame:CGRectMake(CGRectGetMinX(_shutterBtn.frame), 60, 40, 30)];
    ...
    //切换前后摄像头
    UIButton *shiftBtn=[[UIButton alloc]initWithFrame:CGRectMake(CGRectGetMinX(_shutterBtn.frame), 120, 40, 30)];
